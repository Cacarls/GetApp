...
const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div
        className={`relative z-10 rounded-sm px-8 py-10 shadow-three hover:shadow-one ${
          isLightMode ? 'bg-white text-black border border-gray-400' : 'bg-gray-dark text-white'
        }`}
      >
