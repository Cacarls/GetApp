...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: <img src="/images/features/delivery.png" alt="The Best Courier" width="80" height="80" />,
  ...
  {
    id: 2,
    icon: <img src="/images/features/easy.png" alt="Easy To Use" width="80" height="80" />,
    title: "Easy To Use",
    paragraph:
  ...
  {
    id: 3,
    icon: <img src="/images/features/support.png" alt="24/7 Support" width="80" height="80" />,
    title: "24/7 Support",
    paragraph:
